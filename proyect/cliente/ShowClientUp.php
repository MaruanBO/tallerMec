  ...
  <body>
    ...
    <?php
      ...
      require_once 'conn.php';
        ...
        class ClientToUpdate extends Conn {
        ...
        $user = new ClientToUpdate();
        $user->showClientToUpdate();
