          ...
          <ul class="navbar-nav mr-auto text-center">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarCatalogo">
                <a class="dropdown-item" href="http://localhost/web1/vehiculo/verVehic.php">Mi coche</a>
                <a class="dropdown-item" href="http://localhost/web1/cliente/verClient.php">Mis datos</a>
                <a class="dropdown-item" href="http://localhost/web1/cliente/FormClientUp.php">Actualizar Perfil</a>
                <a class="dropdown-item disabled" href="#">Actualizar Coche</a>
              </div>
            </li>
            <li class="nav-item">
