...
<html lang="es">
  <head>
    ...
    <title>Empleado | Mostrar datos</title>
  </head>
  <body>
    <?php
            ...
            public function load($dni) {
                ...
                echo '
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control" title="e.g Pepe Gonzales Morales" pattern="[A-Za-z]{3,15}+" required value="'.$row["nombre"].'"}">
                    </div>
                    <div class="form-group mb-2">
